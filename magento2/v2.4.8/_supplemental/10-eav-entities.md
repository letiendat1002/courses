...
The decision between EAV and extension attributes should be driven by whether you need admin-managed, per-store, or searchable attributes (EAV) versus simple API extension data (extension attributes).